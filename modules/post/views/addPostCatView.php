            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo set_value('post_cat_title'); ?>">
                        <?php echo form_error('post_cat_title') ?>
                        <label for="title">Slug ( Friendly_url )</label>
                        <input type="text" name="slug" id="slug" value="<?php echo set_value('slug'); ?>">
                        <label for="desc">Mô tả</label>
                        <textarea name="desc" id="desc"><?php echo set_value('post_cat_desc'); ?></textarea>
                        <?php if (!empty($list_post_cat)) {
                            ...
                            <select name="parent-cat">
                                ...
                                <?php foreach ($list_post_cat as $cat_item) {
                                    ?>
                                    <option value="<?php echo $cat_item['post_cat_id']; ?>" <?php echo $cat_item['post_cat_id'] == set_value('parent_cat') ? "selected" : ""; ?>><?php echo $cat_item['post_cat_title']; ?></option>
                                <?php }
                                ?>
                            </select>
                        <?php }
